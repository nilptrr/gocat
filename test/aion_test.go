...
func TestAIONValidator(t *testing.T) {
	...
	for _, address := range validAddresses {
		if validationResult := validators.AIONValidator(address); validationResult != true {
	...
	invalidAddresses := []string{
		...
		"0xa0bc56fa67275de02841bfe21043c153b6eabfd095b3b9067ee531070ede8c",
	...
	for _, address := range invalidAddresses {
		if validationResult := validators.AIONValidator(address); validationResult != false {
